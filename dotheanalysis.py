...
text(T/9, 0.8, stringa2, bbox=dict(facecolor='red', alpha=0.8))
...
text(T-3, x0-0.1, stringa, bbox=dict(facecolor='orange', alpha=0.8))
text(T-1, x0-0.1, stringa2, bbox=dict(facecolor='red', alpha=0.8))
